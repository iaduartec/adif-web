...
export const lessons: readonly Lesson[] = [
  {
    ...
    officialReferences: [{ title: "Ley Orgánica 3/2007, para la igualdad efectiva de mujeres y hombres", origin: "official_reference" }],
  ...
  },
  {
    ...
    origin: "original_explanation",
    officialReferences: [{ title: "Ley 31/1995, de Prevención de Riesgos Laborales", origin: "official_reference" }],
    verificationNote: finalAnnexVerification,
  },
  {
    slug: "estatuto-adif",
    ...
    origin: "original_explanation",
    officialReferences: [{ title: "Real Decreto 2395/2004, Estatuto de la entidad pública empresarial ADIF", origin: "official_reference" }],
    verificationNote: finalAnnexVerification,
  },
  {
    ...
    origin: "original_explanation",
    officialReferences: [{ title: "Real Decreto 346/2011, reglamento regulador de las ICT", origin: "official_reference" }],
    verificationNote: finalAnnexVerification,
  },
  {
    ...
    origin: "original_explanation",
    officialReferences: [{ title: "Real Decreto 186/2016, compatibilidad electromagnética", origin: "official_reference" }],
    verificationNote: finalAnnexVerification,
  },
  {
    slug: "rcf-libro-1",
    ...
    origin: "original_explanation",
    officialReferences: [{ title: "Reglamento de Circulación Ferroviaria, Libro Primero", origin: "official_reference" }],
    verificationNote: finalAnnexVerification,
  },
  {
    slug: "psicometria",
    ...
    origin: "original_explanation",
    officialReferences: [{ title: "Bases de la convocatoria y criterios de evaluación aplicables", origin: "official_reference" }],
    verificationNote: finalAnnexVerification,
  },
  {
    slug: "ingles-a2",
    ...
    origin: "original_explanation",
    officialReferences: [{ title: "Marco Común Europeo de Referencia para las Lenguas, nivel A2", origin: "official_reference" }],
    verificationNote: finalAnnexVerification,
  },
];
